...
def sample_courses():
    ...
    return [
        Course(
            ...
            instructor="John Doe",
            lessons=[
                Lesson(lesson_number=1, title="What is MCP?", lesson_link="https://example.com/mcp-intro/lesson1"),
                Lesson(lesson_number=2, title="MCP Architecture", lesson_link="https://example.com/mcp-intro/lesson2")
            ]
        ),
        Course(
            ...
            lessons=[
                ...
                Lesson(lesson_number=2, title="Metaclasses", lesson_link="https://example.com/python/lesson2")
            ]
        )
    ]
...
def mock_vector_store():
    ...
    mock_store.search.return_value = SearchResults(
        documents=["MCP (Model Context Protocol) is a standardized way for applications to provide context to AI models."],
...
def mock_anthropic_client_with_tool_use():
    ...
    final_response.content = [Mock(text="Based on the course content, MCP stands for Model Context Protocol.")]
...
def mock_rag_system(test_config):
    ...
    with patch('rag_system.DocumentProcessor'), \
        ...
        mock_ai_generator.generate_response.return_value = "This is a test response about MCP."
