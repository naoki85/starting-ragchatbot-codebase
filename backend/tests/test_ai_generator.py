...
class TestAIGeneratorBasic:
    ...
    def test_generate_response_without_tools(self, ai_generator_with_mock_client, mock_anthropic_client):
    ...
    def test_generate_response_with_conversation_history(self, ai_generator_with_mock_client, mock_anthropic_client):
...
class TestAIGeneratorToolIntegration:
    ...
    def test_generate_response_with_tools_no_tool_use(self, mock_anthropic_client, tool_manager_with_search_tool):
    ...
    def test_generate_response_with_tool_use_success(self, mock_anthropic_client_with_tool_use, tool_manager_with_search_tool):
        ...
        # Verify
        assert response == "Based on the course content, MCP stands for Model Context Protocol."
        
        # Verify tool was executed
        tool_manager_with_search_tool.tools["search_course_content"].store.search.assert_called_once_with(
            query="What is MCP?",
            course_name=None,
            lesson_number=None
        )
    ...
    def test_tool_execution_flow_messages(self, mock_anthropic_client_with_tool_use, tool_manager_with_search_tool):
    ...
    def test_tool_execution_with_multiple_tools(self):
        ...
        tool_use_2.input = {"query": "MCP architecture", "course_name": "Introduction to MCP"}
        ...
        final_response.content = [Mock(text="Combined response from multiple tool calls.")]
        ...
        tool_manager.execute_tool.assert_any_call("search_course_content", query="What is MCP?")
        tool_manager.execute_tool.assert_any_call("search_course_content", query="MCP architecture", course_name="Introduction to MCP")
    ...
    def test_tool_execution_error_handling(self, tool_manager_with_search_tool):
        ...
        tool_manager_with_search_tool.execute_tool = Mock(return_value="Search failed: Database error")
    ...
    def test_conversation_history_with_tool_use(self, mock_anthropic_client_with_tool_use, tool_manager_with_search_tool):
...
class TestAIGeneratorToolManager:
    ...
    def test_system_prompt_content(self, ai_generator_with_mock_client, mock_anthropic_client):
...
class TestAIGeneratorSequentialTooling:
    ...
    def test_sequential_fallback_without_tools(self, ai_generator_with_mock_client, mock_anthropic_client):
    ...
    def test_sequential_single_round_no_tool_use(self, mock_anthropic_client, tool_manager_with_search_tool):
    ...
    def test_sequential_single_round_with_tool_use(self, mock_anthropic_client_with_tool_use, tool_manager_with_search_tool):
