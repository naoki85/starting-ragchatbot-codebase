...
class TestCourseSearchToolExecute:
    ...
    def test_execute_query_only_success(self, course_search_tool, mock_vector_store, successful_search_results):
    ...
    def test_execute_with_course_name_success(self, course_search_tool, mock_vector_store, successful_search_results):
    ...
    def test_execute_with_lesson_number_success(self, course_search_tool, mock_vector_store, successful_search_results):
    ...
    def test_execute_with_both_filters_success(self, course_search_tool, mock_vector_store, successful_search_results):
    ...
    def test_execute_empty_results_no_filters(self, course_search_tool, mock_vector_store, empty_search_results):
    ...
    def test_execute_empty_results_with_course_filter(self, course_search_tool, mock_vector_store, empty_search_results):
        """Test execute with empty results and course filter"""
        # Setup
        mock_vector_store.search.return_value = empty_search_results
        
        # Execute
        result = course_search_tool.execute(query="non-existent topic", course_name="Test Course")
        
        # Verify
        assert result == "No relevant content found in course 'Test Course'."

    def test_execute_empty_results_with_lesson_filter(self, course_search_tool, mock_vector_store, empty_search_results):
    ...
    def test_execute_empty_results_with_both_filters(self, course_search_tool, mock_vector_store, empty_search_results):
    ...
    def test_execute_search_error(self, course_search_tool, mock_vector_store, error_search_results):
    ...
    def test_execute_source_tracking_with_lesson_links(self, course_search_tool, mock_vector_store):
    ...
    def test_execute_source_tracking_without_lesson_links(self, course_search_tool, mock_vector_store):
    ...
    def test_execute_source_tracking_error_handling(self, course_search_tool, mock_vector_store):
    ...
    def test_execute_unknown_course_metadata(self, course_search_tool, mock_vector_store):
    ...
    def test_execute_multiple_results_source_tracking(self, course_search_tool, mock_vector_store):
        ...
        assert course_search_tool.last_sources[0]["link"] == "https://example.com/a/lesson1"
        assert course_search_tool.last_sources[1]["text"] == "Course B - Lesson 2"
        assert course_search_tool.last_sources[1]["link"] == "https://example.com/b/lesson2"
